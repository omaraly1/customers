                    ...
                    <form method="POST">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" maxlength="128" name="fName" id="fName" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="lname" class="col-sm-3 col-form-label">Last Name</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" maxlength="128" name="lName" id="lName" required>
                                </div>
                            </div>
                        </div>
                    ...
                    <form method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class=form-control name="custSelect" id="custSelect" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" maxlength="128" name="desc" id="desc" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="num" class="col-sm-3 col-form-label">Number</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" maxlength="32" name="num" id="num" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="street" class="col-sm-3 col-form-label">Street</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" maxlength="128" name="street" id="street" required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class=form-control name="provSelect" id="provSelect" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" maxlength="16" name="postal" id="postal" required>
                                </div>
                            </div>
